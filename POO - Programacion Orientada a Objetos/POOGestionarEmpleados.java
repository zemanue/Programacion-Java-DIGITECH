...
public class POOGestionarEmpleados {
    ...
    public static void main(String[] args) {
        ...
        Scanner sc = new Scanner(System.in);
        int opcion;
        POOGestionarEmpleados empleados = new POOGestionarEmpleados();
            ...
            switch (opcion) {
                        ...
                        if (respuesta.equals("1")) {
                            ...
                            do {
                                ...
                                if (posicion < 1 || posicion > listaEmpleados.size()) {
                                    System.out.println("Debe ser un número comprendido entre 1 y " + listaEmpleados.size() + " (el tamaño de la lista actualmente).");

                                //Si el número es válido    
                                } else {
                                    System.out.println("El nombre asignado en esa posición es: " + listaEmpleados.get(posicion - 1));
                        ...
                        //Opción 2: borrar por nombre
                            ...
                            do {
                                ...
                                if (nombreEmpleado.equalsIgnoreCase("salir")) { //Si se escribe 'salir', se sale de nuevo al inicio
                                    System.out.println("Volviendo al inicio.");
                                    break;
                                } else if (listaEmpleados.contains(nombreEmpleado.toLowerCase())) {   //Si coincide con algún elemento de la lista, se elimina el nombre y se pide otro nombre.
                ...
                case 4:     //VISUALIZAR UN NOMBRE
                    ...
                    do { 
                        ...
                        if (posicion < 1 || posicion > listaEmpleados.size()) {
                            System.out.println("Debe ser un número comprendido entre 0 y " + listaEmpleados.size() + " (el tamaño de la lista actualmente).");
                        } else {
                            System.out.println("Nombre de la posición " + posicion + ": " + listaEmpleados.get(posicion - 1)  + ".");
